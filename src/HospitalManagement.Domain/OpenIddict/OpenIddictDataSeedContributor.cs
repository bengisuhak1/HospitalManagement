...
namespace HospitalManagement.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["HospitalManagement_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["HospitalManagement_Web:RootUrl"]!.EnsureEndsWith('/');

            /* HospitalManagement_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["HospitalManagement_Web:ClientSecret"] ?? "1q2w3e*",
